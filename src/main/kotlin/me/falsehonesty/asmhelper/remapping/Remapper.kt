...
interface Remapper {
     ...
     */
    fun remapMethodName(owner: String, methodName: String, methodDesc: String) =
        remapMethodName(Descriptor(owner, methodName, methodDesc))
     ...
     */
    fun remapFieldName(owner: String, fieldName: String, fieldDesc: String) =
        remapFieldName(Descriptor(owner, fieldName, fieldDesc))
